...
ayurmed = pd.read_csv("datasets/ayurmedications.csv")
...
def helper(dis):
    ...
    ayur_med = ayurmed[ayurmed['Disease'] == dis]['Medication']
    ayur_med = [ayur_med for ayur_med in ayur_med.values]

    wrkout = workout[workout['disease'] == dis] ['workout']


    return desc,pre,med,die,wrkout,ayur_med
...
def predict():
    if request.method == 'POST':
        ...
        user_symptoms = [symptom1, symptom2, symptom3, symptom4]
        ...
        dis_des, precautions, medications, rec_diet, workout, ayur_med = helper(predicted_disease)

        my_precautions = []
        for i in precautions[0]:
            my_precautions.append(i)

        return render_template('healthreport.html', predicted_disease=predicted_disease, dis_des=dis_des,
                               my_precautions=my_precautions, medications=medications, my_diet=rec_diet,
                               workout=workout, ayur_med=ayur_med)
